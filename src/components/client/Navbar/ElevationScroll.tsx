 ...
 */
export const HideOnScroll = ({ children }: any) => {
	...
	return (
		<Slide
			...
			sx={{ background: (theme: { palette: { background: { default: any; }; }; }) => (elevationTrigger ? theme.palette.background.default : 'transparent') }}
		>
			{children}
		</Slide>
	);
